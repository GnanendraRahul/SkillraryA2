...
/**
 * This class contains all reusable methods to perform driver related opertaions
 * 
 * @author admin
 */
public class WebDriverUtility {
	...
	/**
	 * This method is used to navigateto specified url
	 * 
	 * @param url
	 */
	...
	/**
	 * This method is an implicit wait statment which waits until element is found
	 * 
	 * @param time
	 */
	...
	/**
	 * This metho waits until element is displayed on the web page
	 * 
	 * @param time
	 * @param element
	 * @return
	...
	/**
	 * This method waits until element is enabled to receive click
	 * 
	 * @param element
	 * @param time
	 * @return
	...
	/**
	 * This method is usedto drag and drop an element to target location
	 * 
	 * @param element
	 * @param target
	 */
	...
	/**
	 * This method is used to swtich to frame based on specified index
	 * 
	 * @param index
	 */
	...
	/**
	 * This method is used to select an element from drop doen based on element
	 * index
	 * 
	 * @param element
	 * @param index
	...
	/**
	 * This method returns child window address
	 */
